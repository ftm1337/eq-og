...
function Unlock({ closeModal, classes }) {
  ...
  useEffect(() => {
    ...
    stores.emitter.on(ERROR, onError)

    return () => {
      stores.emitter.removeListener(CONNECTION_CONNECTED, connectionConnected)
      stores.emitter.removeListener(CONNECTION_DISCONNECTED, connectionDisconnected)
      stores.emitter.removeListener(ERROR, onError)
    }
  }, [])
